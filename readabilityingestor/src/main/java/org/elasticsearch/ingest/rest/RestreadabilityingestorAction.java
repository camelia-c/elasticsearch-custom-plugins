...
public class RestreadabilityingestorAction extends BaseRestHandler {

    public RestreadabilityingestorAction(final Settings settings,
    ...
    protected RestChannelConsumer prepareRequest(final RestRequest request,
        ...
        return channel -> {
            ...
            builder.field("description",
                    "This is a readabilityingestor response: " + new Date().toString());
            builder.endObject();
